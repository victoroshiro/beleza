...
export class DetailsPage {
  ...
  constructor(public navParams: NavParams, public app: UtilProvider, public modalCtrl: ModalController, public alertCtrl: AlertController, public loadingCtrl: LoadingController, public http: Http) {
    ...
    this.idDetails = this.navParams.get("id");
  ...
  getDetailsContent() {
    ...
    this.getProvider(this.idDetails);
  ...
  getProvider(id, refresher = null) {
    ...
    this.http.post(this.web.api + "/provider/", JSON.stringify({id: this.navParams.get("id")}))
    .map(res => res.json())
    .subscribe(success => {
